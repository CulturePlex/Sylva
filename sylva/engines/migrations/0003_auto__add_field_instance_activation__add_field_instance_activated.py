...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.activation'
        db.add_column('engines_instance', 'activation',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Instance.activated'
        db.add_column('engines_instance', 'activated',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.activation'
        db.delete_column('engines_instance', 'activation')

        # Deleting field 'Instance.activated'
        db.delete_column('engines_instance', 'activated')
