...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('engines_instance', 'type',
                      self.gf('django.db.models.fields.CharField')(default='private', max_length=8, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.type'
        db.delete_column('engines_instance', 'type')
