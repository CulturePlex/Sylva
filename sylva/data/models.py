...
class Data(models.Model):
    ...
    total_nodes = models.IntegerField(_("total_nodes"), default=0)
    total_relationships = models.IntegerField(_("total_relationships"),
                                              default=0)

    def __unicode__(self):
        if self.instance:
            return u"%s" % self.instance.name
        else:
            return _(u"(Public instance)")
