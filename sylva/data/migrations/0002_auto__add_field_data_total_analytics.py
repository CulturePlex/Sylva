...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Data.total_analytics'
        db.add_column(u'data_data', 'total_analytics',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Data.total_analytics'
        db.delete_column(u'data_data', 'total_analytics')
