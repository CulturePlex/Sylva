...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RelationshipType.options'
        db.add_column('schemas_relationshiptype', 'options',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'NodeType.options'
        db.add_column('schemas_nodetype', 'options',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RelationshipType.options'
        db.delete_column('schemas_relationshiptype', 'options')

        # Deleting field 'NodeType.options'
        db.delete_column('schemas_nodetype', 'options')
