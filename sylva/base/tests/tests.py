...
class SplinterTestCase(LiveServerTestCase):
    ...
    def test_splinter_singup(self):
        ...
        self.browser.find_by_name('username').fill('pepe')
        self.browser.find_by_name('email').fill('pepe@cultureplex.ca')
        self.browser.find_by_name('password1').fill('pepe_password')
        self.browser.find_by_name('password2').fill('pepe_password')
