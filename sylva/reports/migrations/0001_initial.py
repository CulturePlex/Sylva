...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reports_reporttemplate', (
            ...
            ('slug', self.gf('sylva.fields.AutoSlugField')(db_index=False, unique=True, max_length=250, populate_from=['name'], blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('frequency', self.gf('django.db.models.fields.CharField')(default=u'w', max_length=1)),
            ('last_run', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('layout', self.gf('jsonfield.fields.JSONField')()),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('graph', self.gf('django.db.models.fields.related.ForeignKey')(related_name='report_templates', to=orm['graphs.Graph'])),
        ))
        db.send_create_signal(u'reports', ['ReportTemplate'])

        # Adding M2M table for field queries on 'ReportTemplate'
        m2m_table_name = db.shorten_name(u'reports_reporttemplate_queries')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('reporttemplate', models.ForeignKey(orm[u'reports.reporttemplate'], null=False)),
            ('query', models.ForeignKey(orm[u'queries.query'], null=False))
        ))
        db.create_unique(m2m_table_name, ['reporttemplate_id', 'query_id'])

        # Adding M2M table for field email_to on 'ReportTemplate'
        m2m_table_name = db.shorten_name(u'reports_reporttemplate_email_to')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('reporttemplate', models.ForeignKey(orm[u'reports.reporttemplate'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['reporttemplate_id', 'user_id'])

        # Adding model 'Report'
        db.create_table(u'reports_report', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_run', self.gf('django.db.models.fields.DateTimeField')()),
            ('slug', self.gf('sylva.fields.AutoSlugField')(db_index=False, unique=True, max_length=250, populate_from=['date_run'], blank=True)),
            ('table', self.gf('jsonfield.fields.JSONField')()),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reports', to=orm['reports.ReportTemplate'])),
            ('report_file', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field queries on 'ReportTemplate'
        db.delete_table(db.shorten_name(u'reports_reporttemplate_queries'))

        # Removing M2M table for field email_to on 'ReportTemplate'
        db.delete_table(db.shorten_name(u'reports_reporttemplate_email_to'))
