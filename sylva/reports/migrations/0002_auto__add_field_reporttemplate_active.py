...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportTemplate.active'
        db.add_column(u'reports_reporttemplate', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportTemplate.active'
        db.delete_column(u'reports_reporttemplate', 'active')
