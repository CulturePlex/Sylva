...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Analytic.task_error'
        db.add_column(u'analytics_analytic', 'task_error',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Analytic.task_error'
        db.delete_column(u'analytics_analytic', 'task_error')
