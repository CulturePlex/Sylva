...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Analytic.values'
        db.add_column(u'analytics_analytic', 'values',
                      self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Analytic.values'
        db.delete_column(u'analytics_analytic', 'values')
    ...
    models = {
        u'analytics.analytic': {
            ...
            'values': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'analytics.dump': {
