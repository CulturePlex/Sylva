...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Analytic.raw'
        db.alter_column(u'analytics_analytic', 'raw', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

        # Changing field 'Analytic.results'
        db.alter_column(u'analytics_analytic', 'results', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

        # Changing field 'Dump.data_file'
        db.alter_column(u'analytics_dump', 'data_file', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Analytic.raw'
        db.alter_column(u'analytics_analytic', 'raw', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Analytic.results'
        db.alter_column(u'analytics_analytic', 'results', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Dump.data_file'
        db.alter_column(u'analytics_dump', 'data_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    models = {
        u'analytics.analytic': {
            ...
            'raw': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'results': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'analytics.dump': {
            ...
            'data_file': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
