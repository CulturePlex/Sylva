...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Analytic.task_id'
        db.alter_column(u'analytics_analytic', 'task_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Analytic.task_error'
        db.alter_column(u'analytics_analytic', 'task_error', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Analytic.dump'
        db.alter_column(u'analytics_analytic', 'dump', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Analytic.algorithm'
        db.alter_column(u'analytics_analytic', 'algorithm', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Analytic.subgraph'
        db.alter_column(u'analytics_analytic', 'subgraph', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Analytic.task_status'
        db.alter_column(u'analytics_analytic', 'task_status', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Analytic.task_id'
        db.alter_column(u'analytics_analytic', 'task_id', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Analytic.task_error'
        db.alter_column(u'analytics_analytic', 'task_error', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Analytic.dump'
        db.alter_column(u'analytics_analytic', 'dump', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Analytic.algorithm'
        db.alter_column(u'analytics_analytic', 'algorithm', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'Analytic.subgraph'
        db.alter_column(u'analytics_analytic', 'subgraph', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Analytic.task_status'
        db.alter_column(u'analytics_analytic', 'task_status', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    models = {
        u'analytics.analytic': {
            'Meta': {'object_name': 'Analytic'},
            'algorithm': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'dump': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'data.data': {
            ...
            'total_analytics': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
