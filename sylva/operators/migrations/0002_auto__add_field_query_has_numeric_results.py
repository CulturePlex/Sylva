...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.has_numeric_results'
        db.add_column(u'operators_query', 'has_numeric_results',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.has_numeric_results'
        db.delete_column(u'operators_query', 'has_numeric_results')
    ...
    models = {
        ...
        u'operators.query': {
            ...
            'has_numeric_results': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
