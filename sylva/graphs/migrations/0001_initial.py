...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('graphs_graph', (
            ...
            ('data', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['data.Data'], unique=True)),
            ('schema', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['schemas.Schema'], unique=True, null=True, blank=True)),
            ('relaxed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('options', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('graphs', ['Graph'])

        # Adding unique constraint on 'Graph', fields ['owner', 'name']
        db.create_unique('graphs_graph', ['owner_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Graph', fields ['owner', 'name']
        db.delete_unique('graphs_graph', ['owner_id', 'name'])
