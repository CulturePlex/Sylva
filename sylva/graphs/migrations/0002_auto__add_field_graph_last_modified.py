...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Graph.last_modified'
        db.add_column(u'graphs_graph', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Graph.last_modified'
        db.delete_column(u'graphs_graph', 'last_modified')
